...
document.getElementById("deleteRepo").addEventListener("click", async () => {
  ...
  const pass = document.getElementById("deleteRepoPassword").value.toString();
  ...
  if (result == "Failure") {
    loadingModal.hide();
    deleteModal.show();
    document.getElementById("deleteWrongPassword").innerHTML = "Incorrect password";
...
// Generate deltas to prepare commit
...
// Return from commit view to code view
...
// Determines changes between two sets of code files
...
// Generates updated code file with given deltas
...
// Retrieves commits from existing repo and updates repository page
...
// Load previous commit and prepare commit view
...
// Change code editor on file click
...
// Changes code view to commit view
